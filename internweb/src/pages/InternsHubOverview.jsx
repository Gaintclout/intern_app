        ...
        <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="text-6xl font-semibold text-gaint-blue">
              ...
              <p className="mt-4 text-gray-600 text-3xl leading-relaxed">
            Traditional education emphasizes theoretical instruction,{" "}
            while{" "}
            <span className="bg-[#3F5BD8] text-white px-2 py-1 rounded">
              professional environments demand applied problem-solving,
              system thinking, and tool proficiency.
            </span>
          </p>

          <p className="mt-4 text-gray-600 text-3xl leading-loose">
            InternsHub bridges this gap by{" "}
            <span className="bg-[#3F5BD8] text-white px-2 py-1 inline">
              embedding learning directly
            </span>{" "}
            into{" "}
            <span className="bg-[#3F5BD8] text-white px-2 py-1 inline">
              real project execution supported
            </span>{" "}
            by{" "}
            <span className="bg-[#3F5BD8] text-white px-2 py-1 inline">
